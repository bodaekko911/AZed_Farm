...
def inventory_ui(current_user: User = Depends(require_permission("page_inventory"))):
    return """
<!DOCTYPE html>
<html>
<head>
...
<title>Inventory — AZed Farm</title>
...
""" + render_app_header(current_user, "page_inventory") + """
