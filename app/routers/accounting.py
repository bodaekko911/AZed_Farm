...
def accounting_ui(current_user: User = Depends(require_permission("page_accounting"))):
    return """
<!DOCTYPE html>
<html>
<head>
...
<title>Accounting — AZed Farm</title>
...
<body>
""" + render_app_header(current_user, "page_accounting") + """
