...
def production_ui(current_user: User = Depends(require_permission("page_production"))):
    return """<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<title>Production — AZed Farm</title>
...
<body>
""" + render_app_header(current_user, "page_production") + """
