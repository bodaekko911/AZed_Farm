...
(function () {
  ...
  var DICT = {
    ...
    "Excel export failed": "فشل تصدير إكسل",
    "Excel export permission required": "مطلوب إذن تصدير إكسل",
    "Export the filtered product list as Excel": "تصدير قائمة المنتجات المفلترة إلى إكسل",
    "Excel": "إكسل",
    ...
    "Sustainability Report": "تقرير الاستدامة",
