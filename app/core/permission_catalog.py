...
PERMISSION_MATRIX = [
    ...
    },
    {
        ...
        "icon": "🌾",
        "actions": [
            {"action": "view",           "key": "page_drying",                    "label": "Open drying"},
            {"action": "cancel_batch",   "key": "action_drying_cancel_batch",     "label": "Cancel drying batch"},
            {"action": "complete_batch", "key": "action_drying_complete_batch",   "label": "Complete drying batch"},
            {"action": "log_spoilage",   "key": "action_drying_log_spoilage",     "label": "Log spoilage on drying batch"},
            {"action": "start_batch",    "key": "action_drying_start_batch",      "label": "Start drying batch"},
        ],
    },
    {
        "module": "farm",
