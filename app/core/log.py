...
def configure_logging() -> None:
    ...
    # File logging is optional. In containers we log to stdout only (captured
    # by Docker/Railway) and skip the file handler entirely, so the image
    # needs no writable log directory. Local dev keeps file logging by default.
